    ...
    <div className="p-6 flex flex-col gap-4 bg-background border border-border rounded-lg">
      <div className="grid grid-cols-2 gap-6">
        <div className="flex-1">
          <h3 className="text-black font-bold">Ажлын байрны тодорхойлолт</h3>
          <Label htmlFor="jobDescription" className="text-gray-500 mt-2">
            Ажлын талаарх дэлгэрэнгүй тайлбар бичнэ үү.
          </Label>
        </div>
        <div className="flex-1">
          <MyEditor />
            ...
            <div>
              <Select onValueChange={setSalaryType}>
                ...
                <SelectContent className="w-[120px] mt-2">
                  <SelectItem value="Yearly">Жил</SelectItem>
                  <SelectItem value="Month">Сар</SelectItem>
                  <SelectItem value="Hour">Цаг</SelectItem>
                  <SelectItem value="Fixed">Тохиролцох</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
